...
export declare const buyStardust: (req: Request, res: Response) => Promise<Response<any, Record<string, any>> | undefined>;
export declare const buyPremium: (req: Request, res: Response) => Promise<Response<any, Record<string, any>> | undefined>;
