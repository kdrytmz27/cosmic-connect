export function calculateSunSign(day: number, month: number): string {
    const dates = [
...
export function calculateMoonSign(year: number, month: number, day: number): string {
...
export function calculateRisingSign(birthTime: string, sunSign: string): string {
